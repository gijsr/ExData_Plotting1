...
par(mfrow=c(2,2)) # 2 rows 2 cols, plotted over rows
plot(projectfile$DateTime,projectfile$Global_active_power, type="l", xlab="", ylab="Global Active Power", bg="transparent")  # plot2.R, changed ylab
plot(projectfile$DateTime,projectfile$Voltage, type="l",xlab="datetime",ylab="Voltage",bg="transparent")
...
legend("topright",lty=1,bty="n",col=c("black","red","blue"), legend =c("Sub_metering_1", "Sub_metering_2","Sub_metering_3")) # same as plot3.R
plot(projectfile$DateTime,projectfile$Global_reactive_power, type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()
